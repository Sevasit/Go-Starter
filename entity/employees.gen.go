...
func newEmployee(db *gorm.DB, opts ...gen.DOOption) employee {
	...
	_employee.CountryID = field.NewInt32(tableName, "country_id")
	_employee.Salary = field.NewInt32(tableName, "salary")
	_employee.DepartmentID = field.NewInt32(tableName, "department_id")
	_employee.FirstName = field.NewString(tableName, "first_name")
	_employee.CommissionPct = field.NewFloat64(tableName, "commission_pct")
...
func (e *employee) updateTableName(table string) *employee {
	...
	e.CountryID = field.NewInt32(table, "country_id")
	e.Salary = field.NewInt32(table, "salary")
	e.DepartmentID = field.NewInt32(table, "department_id")
	e.FirstName = field.NewString(table, "first_name")
	e.CommissionPct = field.NewFloat64(table, "commission_pct")
